/*
┌─────────────────────────────────────────────────────────────────────────────┐
│ malloc, calloc, realloc, and free procs that emscripten exposes to manage   │
│ memory. This aims for alignment with Odin's default heap allocator, so maps │
│ and simd can be used.                                                       │
└─────────────────────────────────────────────────────────────────────────────┘
*/
...
/*
┌─────────────────────────────────────────────────────────────────────────────┐
│ Bindings to emscriptens implementation of libc memory allocation features.  │
└─────────────────────────────────────────────────────────────────────────────┘
*/
...
aligned_raylib_allocator_proc :: proc(
	...
	/*
	┌───────────────────────────────────────────────────────────────────────────┐
	│ aligned alloc procs similar to `_heap_allocator_proc` in `core:os` to     │
	│ allow the usage of maps and simd features.                                │
	└───────────────────────────────────────────────────────────────────────────┘
	*/
	aligned_alloc :: proc(
		size, alignment: int,
		...
		if old_ptr != nil {
			...
			/*
			┌───────────────────────────────────────────────────────────────────────┐
			│ calloc automatically zeroes memory. It takes a number + size instead  │
			│ of just size.                                                         │
			└───────────────────────────────────────────────────────────────────────┘
			*/
